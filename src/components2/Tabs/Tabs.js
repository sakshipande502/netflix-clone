...
const Tabs = ({ activeTabName, onClickTab }) => {
  const { CANCEL_AT_ANY_TIME, PICK_YOU_PRICE, WATCH_ANYWHERE } = tabLabels;
    ...
    <>
      ...
      {activeTabName === CANCEL_AT_ANY_TIME && (
        <section className="tab-content">
          <div className="container">
            ...
            >
              <div className="tab1-1-content-inner">
                <div>
                  <p className="text-lg">
                    If you decide Netflix isn't for you - no problem.
                    <br></br> No commitment. Cancel online anytime.
                  </p>
                  <Link to="/Netflixshow" className="btn btn-lg" onClick={() => onClickTab(CANCEL_AT_ANY_TIME)}>
                ...
                <img style={{
                  ...
                  marginLeft:"620px",
                  width:"500px"
                }} src="https://i.ibb.co/J2xDJV7/tab-content-1.png"  alt="img" />
              </div>
            </div>
          </div>
        </section>
      ...
      {activeTabName === WATCH_ANYWHERE &&(
        <section className='tab-content'>
          ...
          <div
            ...
            <p className="text-lg">
                  Watch TV show and movie anytime, anywhere -personalized for you.
                  </p>
                  <Link to="/Netflixshow" className="btn btn-lg" onClick={() => onClickTab(CANCEL_AT_ANY_TIME)}>
                    Watch Free for 30 days
                  </Link>
            ...
            <div className='tab-2-content-bottom'>
              <div>
                <img src="https://i.ibb.co/DpdN7Gn/tab-content-2-1.png" alt="img"></img>
                <p className='text-md'>Watch on your TV </p>
                <p className='text-dark'>
                  Smart Vs,PLayStation,Xbox,Chromecast,Apple TV,Blu-ray players and more
                </p>
              </div>
              <div>
      ...
      {activeTabName === PICK_YOU_PRICE &&(
        <section className='tab-content'>
           ...
           <div
              id="tab-3-content"
              className={`tab-content-item ${activeTabName === PICK_YOU_PRICE && 'show'}`}
            >
